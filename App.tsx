  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-950">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 grid grid-cols-1 xl:grid-cols-2 gap-6 pb-20">
          <ChartPanel
          ...
          />
           ...
           <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6 flex flex-col justify-center">
